...
namespace cpcApi.Migrations
{
    ...
    [Migration("20260213010157_alter_table_order_cpc_add_status")]
    partial class alter_table_order_cpc_add_status
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("cpcApi.Model.Cpc.MutasiVault", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("ReferenceNo", "TipeMutasi")
                        .HasDatabaseName("IX_MUTASIVAULT_REF_TIPE");

                    b.HasIndex("KdCabang", "KdBank", "Nominal")
                        .IsUnique()
                        .HasDatabaseName("UX_MUTASIVAULT_SALDOAWAL")
                        .HasFilter("[TipeMutasi] = 'SALDO_AWAL'");

                    b.HasIndex("KdCabang", "KdBank", "Nominal", "CreatedAt")
            ...
            modelBuilder.Entity("cpcApi.Model.Cpc.OrderPengisianKasetDetail", b =>
                {
                    ...
                    b.HasIndex("OrderId", "Kaset")
                        .IsUnique();

                    b.HasIndex("OrderId", "KodeKaset")
                        .IsUnique();

                    b.ToTable("OrderPengisianKasetDetail", t =>
                        {
                            t.HasCheckConstraint("CK_OrderDetail_Denom_Positive", "[Denom] >= 0");

                            t.HasCheckConstraint("CK_OrderDetail_Lembar_Positive", "[Lembar] >= 0");
                        });
                });
            ...
            modelBuilder.Entity("cpcApi.Model.Cpc.StokVaultCabang", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("StokVaultCabang", (string)null);
                });

            modelBuilder.Entity("cpcApi.Model.Konfigurasi.AuditLogin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("cpcApi.Model.MasterData.MasterDenom", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
